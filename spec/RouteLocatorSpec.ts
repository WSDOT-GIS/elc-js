...
import { flattenArray } from "../routeUtils";
...
describe("RouteLocator", () => {
    ...
    it("should be able to find route locations with global reference date specified.", (done) => {
        ...
        routeLocator.findRouteLocations(params).then((data) => {
    ...
    it("should be able to find nearest route locations.", (done) => {
        ...
        routeLocator.findNearestRouteLocations(params).then((data) => {
...
describe("utils", () => {
    it("should be able to flatten array.", () => {
        ...
        expect(flattened.length).toEqual(4, "flattened array should have four elements.");

        const input = [1, 2, 3, 4];
        const output = flattenArray(input);

        expect(input.length).toEqual(output.length, "input and output arrays should have the same number of elements.");
...
describe("Serialization", () => {
    it("should be able to be serialized to JSON string", () => {
        ...
        expect(json.ReferenceDate).toEqual(dateString, "The reference date in the output object should be \"" + dateString + "\".");
        expect(json.Route).toEqual(rl.Route, "The \"Route\" properties should be equal.");
