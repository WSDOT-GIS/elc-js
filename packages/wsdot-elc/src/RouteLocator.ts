...
import RouteLocation, { IRouteLocation } from "./RouteLocation";
...
export default class RouteLocator {
   ...
   */
  public async findRouteLocations(
    params: IFindRouteLocationsParameters
  ...
  public async findNearestRouteLocations(
    ...
    if (
      typeof params.referenceDate === "undefined" ||
    ...
    if (
      typeof params.coordinates !== "object" ||
    ...
    if (
      typeof params.lrsYear !== "undefined" &&
      params.lrsYear !== null &&
    ...
    if (
      typeof params.routeFilter !== "undefined" &&
