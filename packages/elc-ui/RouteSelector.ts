...
import RouteId from "wsdot-elc/RouteId";
...
export default class RouteSelector {
    ...
    constructor(root: HTMLElement) {
        ...
        this.mainlineSelect.addEventListener("change", this.addOptionsForCurrentlySelectedMainline, true);
    ...
    public addOptionsForCurrentlySelectedMainline() {
        ...
        for (const route of this._routes) {
            if (route.routeId.sr === mainline) {
                ...
                const label = route.isMainline ? "Mainline" : route.routeId.rrq ? [route.routeId.rrt, route.routeId.rrq].join(" ") : route.routeId.rrt;
                if (label) {
                    option.label = label;
                }
