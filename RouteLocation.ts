...
export default class RouteLocation implements IRouteLocation {
    ...
    constructor(json: IRouteLocation) {
        ...
        this.ReferenceDate = typeof json.ReferenceDate !== "undefined" ? json.ReferenceDate as Date as Date : null;
        this.ResponseDate = typeof json.ResponseDate !== "undefined" ? json.ResponseDate as Date : null;
        this.RealignmentDate = typeof json.RealignmentDate !== "undefined" ? json.RealignmentDate as Date : null;
        ...
        this.EndReferenceDate = typeof json.EndReferenceDate !== "undefined" ? json.EndReferenceDate as Date : null;
        this.EndResponseDate = typeof json.EndResponseDate !== "undefined" ? json.EndResponseDate as Date : null;
        this.EndRealignmentDate = typeof json.EndRealignmentDate !== "undefined" ? json.EndRealignmentDate as Date : null;
            ...
            if (this.hasOwnProperty(prop)) {
                ...
                if (value && value instanceof Date && dateFieldRe.test(prop)) {
                    ...
                    if (typeof value === "string") {
                        const match = routeRe.exec(this[prop]);
                        if (match) {
